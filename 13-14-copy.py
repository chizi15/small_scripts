...
# 获取mnist数据
mnist_data_set = input_data.read_data_sets('G:/python_resources/deeplearing/'
'TensorFlow-wangxiaohua/book codes/source code/13/MNIST_data', one_hot=True)
c = []
